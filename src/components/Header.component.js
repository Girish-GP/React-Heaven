...
export const HeaderComponent = () => {
  ...
  return (
    <div
      id="app-header"
      className="flex px-32 border-b-2 shadow-lg justify-between"
    >
      ...
      <div className="flex items-center">
        <ul className="flex items-center justify-between gap-12">
          ...
          <li>
            {loginText?.toLowerCase() === "logout" && contextData?.loggedInUser}
          </li>
          <li>
            <button
              className="border-2 rounded-2xl bg-cyan-300 pt-1 pb-1 px-3 py-3 shadow-sm"
              onClick={login}
            >
              {loginText}
            </button>
