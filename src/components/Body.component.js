  ...
  return dataCopy?.length ? (
    <div id="app-body" className="mt-8 flex items-center flex-col gap-4">
      ...
      <div className="flex gap-4">
        <button
          className="border-2 rounded-3xl bg-cyan-300 p-3 shadow-sm"
          onClick={filter}
        >
          Top Rated
        </button>
        <button
          className="border-2 rounded-3xl bg-teal-100 p-3 shadow-sm"
          onClick={() => {
            setDataCopy(data);
          }}
        >
              ...
              >
                {
                  ...
                  obj?.info?.isOpen ? (
                    <OpenedRestuarantCards resData={obj} />
                  ) : (
                    <RestaurantCards resData={obj} />
                  )
                }
              </Link>
            </div>
    ...
    <div id="app-body" className="mt-8 flex items-center flex-col gap-4">
      <div className="w-4/12 border-2 flex items-center align-middle h-10 rounded-full bg-gray-200"></div>
